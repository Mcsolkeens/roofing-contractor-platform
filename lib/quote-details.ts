...
const SECTIONS: ServiceSection[] = [
  {
    ...
    questions: [
      {
        id: "roof.type",
        label: "What type of roof are you looking for?",
        kind: "radio",
        required: true,
        options: opts("Shingles", "Metal"),
      },
      {
        id: "roof.underlaymentType",
        label: "What type of underlayment would you like?",
        kind: "radio",
        required: true,
        options: opts("Standard", "Upgraded"),
        showIf: (a) => a["roof.type"] === "shingles",
      },
      {
        id: "roof.standardUnderlayment",
        label: "Choose your standard underlayment",
        kind: "radio",
        required: true,
        options: opts("Synthetic underlayment"),
        showIf: (a) => a["roof.underlaymentType"] === "standard",
      },
      {
        id: "roof.upgradedUnderlayment",
        label: "Choose your upgraded underlayment",
        kind: "radio",
        required: true,
        options: opts("Ice & water protection"),
        showIf: (a) => a["roof.underlaymentType"] === "upgraded",
      },
      {
        id: "roof.accessories",
        label: "Which roof accessories would you like?",
        kind: "checkbox",
        options: opts("Vent", "Drip edge", "Wall flashing"),
      },
      {
        id: "roof.ventType",
        label: "What type of roof vent would you like?",
        kind: "radio",
        required: true,
        options: opts("Ridge", "Duraflo", "Tiered"),
        showIf: (a) => answerArray(a, "roof.accessories").includes("vent"),
      },
      {
        id: "roof.ventColor",
        label: "Choose a roof vent colour",
        kind: "swatch",
